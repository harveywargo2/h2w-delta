...
_delta = 'delta--'
_identity = "identity--" + str(uuid.uuid5(delta_namespace, d2s.delta_identity))
_time = d2s.default_timestamp


comsvcs_p0001 = 'comsvcs-p0001'
comsvcs_p0002 = 'comsvcs-p0002'
comsvcs_p0003 = 'comsvcs-p0003'
comsvcs_p0004 = 'comsvcs-p0004'
...
indicator_comsvcs_p0002 = stix2.Indicator(
...
indicator_comsvcs_p0003 = stix2.Indicator(
