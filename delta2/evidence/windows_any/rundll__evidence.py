...
_rundll_e02 = {
    ...
    "patterns": [
        {
            "process_command_line": r'''"C:\Windows\System32\rundll32.exe C:\windows\System32\comsvcs.dll, MiniDump (Get-Process lsass).id $env:TEMP\lsass-comsvcs.dmp full"'''
        }
    ]
}
...
_rundll_e04 = {
    ...
    "patterns": [
        {
            "action": "read_preocess_memory_api_call",
            "file_name": "lsass.exe",
            "initiating_process_file_name": "rundll32.exe",
            "initiating_process_command_line": r'''"C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe" & {C:\Windows\System32\rundll32.exe C:\windows\System32\comsvcs.dll, MiniDump <PID>Get-Process lsass).id $env:TEMP\lsass-<filename>.dmp full}'''
        }
...
rundll__p0001___evidence = d2s.XDeltaEvidence(
    id=d2s.x_delta_evidence + str(uuid.uuid5(d2s.delta_namespace, "rundll-p0001--evidence")),
    created_by_ref=d2s.delta_identity,
    created="2025-01-01T00:00:00.000Z",
    modified="2025-01-01T00:00:00.000Z",
    object_marking_refs=[stix2.TLP_WHITE],
    name="Evidence Container rundll-p0001",
    x_delta_evidence="rundll-p0001--evidence",
    x_evidence_info=[_rundll_e01, _rundll_e02]
)


rundll__p0002___evidence = d2s.XDeltaEvidence(
    id=d2s.x_delta_evidence + str(uuid.uuid5(d2s.delta_namespace, "rundll-p0002--evidence")),
    created_by_ref=d2s.delta_identity,
    created="2025-01-01T00:00:00.000Z",
    modified="2025-01-01T00:00:00.000Z",
    object_marking_refs=[stix2.TLP_WHITE],
    name="Evidence Container rundll-p0002",
    x_delta_evidence="rundll-p0002--evidence",
    x_evidence_info=[_rundll_e03]
)


rundll__p0003___evidence = d2s.XDeltaEvidence(
    id=d2s.x_delta_evidence + str(uuid.uuid5(d2s.delta_namespace, "rundll-p0003--evidence")),
    created_by_ref=d2s.delta_identity,
    created="2025-01-01T00:00:00.000Z",
    modified="2025-01-01T00:00:00.000Z",
    object_marking_refs=[stix2.TLP_WHITE],
    name="Evidence Container rundll-p0003",
    x_delta_evidence="comsvcs-p0003--evidence",
    x_evidence_info=[_rundll_e04]
)